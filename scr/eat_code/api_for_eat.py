...
def search(type_of_place, longitude:float, latitude:float):
    print('request')
    request = "https://search-maps.yandex.ru/v1/?text="+ type_of_place+"&ll="+str(longitude)+"," + str(latitude) + "&spn=0.223456,0.223456&lang=ru_RU&apikey=8bdea3a2-ac05-4026-9666-a66104c79cca"
    print(request)
